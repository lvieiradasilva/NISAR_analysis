...
* **White/Gray/Light pink:** consistent high backscatter across all three temporal baselines. This shows stable vegetation (for example, evergreen in the forest);
...
* **Black:** shows consistently low backscatter, which could represent bare soil, stable structures, etc.
* **Composite colors:**
